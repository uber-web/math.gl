...
describe('quat2', function () {
  ...
  describe('translate', function () {
    ...
    describe('with a separate output quaternion', function () {
      ...
      it('should not modify vec', function () {
    ...
    describe('when quat2A is the output quaternion', function () {
      ...
      it('should return quat2A', function () {
  ...
  describe('rotateAroundAxis', function () {
    ...
    describe('with a separate output quaternion', function () {
      ...
      it('should not modify ax', function () {
  ...
  describe('rotateByQuatAppend', function () {
    ...
    describe('with a separate output quaternion', function () {
      ...
      it('should not modify the rotation quaternion', function () {
  ...
  describe('from/toMat4', function () {
    ...
    describe('quat to matrix and back', function () {
      ...
      it('should return matOut', function () {
  ...
  describe('create', function () {
    ...
    it('should return 2 4 element arrays initialized to an identity dual quaternion', function () {
  ...
  describe('clone', function () {
    ...
    it('should return 2 4 element arrays initialized to the values in quat2A', function () {
  ...
  describe('add', function () {
    describe('with a separate output dual quaternion', function () {
      ...
      it('should not modify quat2B', function () {
    ...
    describe('when quat2B is the output dual quaternion', function () {
      ...
      it('should place values into quat2B', function () {
        expect(quat2B).toBeEqualishQuat2([6, 8, 10, 12, 11, 13, 12, -6]);
      });
      it('should return quat2B', function () {
  ...
  describe('fromRotation', function () {
    ...
    it('should not modify the quaternion', function () {
      expect(quat2A).toBeEqualishQuat2([1, 2, 3, 4, 2, 5, 6, -2]);
    });
  });
  ...
  describe('fromTranslation', function () {
    ...
    it('should not modify the vector', function () {
  ...
  describe('normalize', function () {
    describe('when it is normalizing quat2A', function () {
      ...
      it('both parts should have been normalized', function () {
  ...
  describe('lerp', function () {
    ...
    describe('shortest path', function () {
      ...
      it('should pick the shorter path', function () {
  ...
  describe('set real/dual', function () {
    describe('set real', function () {
      ...
      it('should not modify outQuat', function () {
  ...
  describe('exactEquals', function () {
    ...
    it('should return true for identical quaternions', function () {
      expect(r0).toBe(true);
    });
    it('should return false for different quaternions', function () {
  ...
  describe('equals', function () {
    ...
    it('should return true for identical dual quaternions', function () {
      expect(r0).toBe(true);
    });
    it('should return false for different dual quaternions', function () {
      expect(r1).toBe(false);
    });
    it('should return true for close but not identical quaternions', function () {
      expect(r2).toBe(true);
    });
    it('should not modify quat2A', function () {
      expect(quat2A).toBeEqualishQuat2([0, 1, 2, 3, 4, 5, 6, 7]);
