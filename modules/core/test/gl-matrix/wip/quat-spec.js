...
describe('quat', function () {
    ...
    describe("from a normal matrix looking 'backward'", function () {
      beforeEach(function () {
        ...
        mat3.transpose(
          ...
          mat3.invert(
            matr,
            mat3.fromMat4(matr, mat4.lookAt(mat4.create(), [0, 0, 0], [0, 0, 1], [0, 1, 0]))
          )
        );
        result = quat.fromMat3(out, matr);
      });
    ...
    describe("from a normal matrix looking 'left' and 'upside down'", function () {
      beforeEach(function () {
        ...
        mat3.transpose(
          ...
          mat3.invert(
            matr,
            mat3.fromMat4(matr, mat4.lookAt(mat4.create(), [0, 0, 0], [-1, 0, 0], [0, -1, 0]))
          )
        );
        result = quat.fromMat3(out, matr);
      });
  ...
  describe('getAxisAngle', function () {
    describe('for a quaternion representing no rotation', function () {
      ...
      it('should return a multiple of 2*PI as the angle component', function () {
    ...
    describe('for a simple rotation about X axis', function () {
      ...
      it('should return the same provided angle', function () {
        expect(deg90).toBeEqualish(0.7778);
      });
      it('should return the X axis as the angle', function () {
        expect(vec).toBeEqualish([1, 0, 0]);
      });
    });
    ...
    describe('for a slightly irregular axis and right angle', function () {
      ...
      it('should place values into vec', function () {
        expect(vec).toBeEqualish([0.707106, 0, 0.707106]);
      });
      it('should return a numeric angle', function () {
    ...
    describe('for a very irregular axis and negative input angle', function () {
      ...
      it('should return an angle between 0 and 2*PI', function () {
        expect(deg90).toBeGreaterThan(0.0);
        expect(deg90).toBeLessThan(Math.PI * 2.0);
      });
      it('should create the same quaternion from axis and angle extracted', function () {
  ...
  describe('equals', function () {
    ...
    it('should return true for identical quaternions with flipped orientation', function () {
      expect(r3).toBe(true);
    });
    it('should not modify quatA', function () {
