...
describe('vec4', function () {
  ...
  describe('ceil', function () {
    ...
    describe('with a separate output vector', function () {
      ...
      it('should not modify vecA', function () {
        expect(vecA).toBeEqualish([Math.E, Math.PI, Math.SQRT2, Math.SQRT1_2]);
      });
    });
  ...
  describe('round', function () {
    ...
    describe('symmetry', function () {
      it('should round negative values torwards negative infinity', function () {
        expect(vec4.round([], [-1.5, -1.5, -2.5, -0.5])).toBeEqualish([-2, -2, -3, -1]);
      });
    });
  });
  ...
  describe('random', function () {
    ...
    describe('with a scale', function () {
      ...
      it('should result in a vector of correct length', function () {
        expect(vec4.len(out)).toBeEqualish(5.0);
      });
      it('should return out', function () {
        expect(result).toBe(out);
      });
    ...
    describe('with a scale of zero', function () {
      beforeEach(function () {
        result = vec4.random(out, 0);
      });

      it('should result in a zero vector', function () {
        expect(vec4.len(out)).toBeEqualish(0);
      });
      it('should return out', function () {
        expect(result).toBe(out);
      });
  ...
  describe('cross', function () {
    ...
    describe('with a separate output vector', function () {
      beforeEach(function () {
        result = vec4.cross(out, vecA, vecB, vecC);
      });
      ...
      it('should not modify vecB', function () {
        expect(vecB).toBeEqualish([0, 1, 0, 0]);
      });
      it('should not modify vecC', function () {
        expect(vecC).toBeEqualish([0, 0, 1, 0]);
      });
    });

    describe('when vecA is the output vector', function () {
      beforeEach(function () {
        result = vec4.cross(vecA, vecA, vecB, vecC);
      });
    ...
    describe('when vecB is the output vector', function () {
      beforeEach(function () {
        result = vec4.cross(vecB, vecA, vecB, vecC);
      });
    ...
    describe('when vecC is the output vector', function () {
      beforeEach(function () {
        result = vec4.cross(vecC, vecA, vecB, vecC);
      });

      it('should place values into vecC', function () {
        expect(vecC).toBeEqualish([0, 0, 0, -1]);
      });
      it('should return vecC', function () {
        expect(result).toBe(vecC);
      });
      it('should not modify vecA', function () {
        expect(vecA).toBeEqualish([1, 0, 0, 0]);
      });
    ...
    describe('when performing operations that take no extra arguments', function () {
      ...
      it('should update all values', function () {
        expect(vecArray).toBeEqualish([
          0.182574, 0.365148, 0.547722, 0.730296, 0.379049, 0.454858, 0.530668, 0.606478, 0, 0, 0, 0
        ]);
      });
  ...
  describe('zero', function () {
    ...
    it('should result in a 4 element vector with zeros', function () {
      expect(result).toBeEqualish([0, 0, 0, 0]);
    });
  });
});
