"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Vector2;module.link('math.gl/vector2',{default(v){Vector2=v}},1);var Matrix3;module.link('math.gl/matrix3',{default(v){Matrix3=v}},2);var x,y;module.link('./constants',{x(v){x=v},y(v){y=v}},3);// This file is copied from THREE.js math test suite (MIT licensed)
