"use strict";var Euler,Matrix4,Quaternion,Pose;module.link('math.gl',{_Euler(v){Euler=v},Matrix4(v){Matrix4=v},Quaternion(v){Quaternion=v},_Pose(v){Pose=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);var tapeEquals;module.link('../utils/tape-equals',{tapeEquals(v){tapeEquals=v}},2);
